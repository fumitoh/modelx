...
@pytest.mark.parametrize("range_expr, sheet", [
    ('NamedRange1', None),
    ('C3:E5', 'SHEET1'),
])
...
@pytest.mark.parametrize("range_expr", [
    'NamedRange1',
    'C3:E5',
])
...
@pytest.mark.parametrize("valid_range_address", [
    'A1',
    'XFD1048576',
    'A1:B3',
    'A1:XFD1048576',
